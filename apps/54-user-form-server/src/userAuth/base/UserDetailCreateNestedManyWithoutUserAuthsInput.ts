...
@InputType()
class UserDetailCreateNestedManyWithoutUserAuthsInput {
...
export { UserDetailCreateNestedManyWithoutUserAuthsInput as UserDetailCreateNestedManyWithoutUserAuthsInput };
